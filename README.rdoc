...
This is a temporary fork of the real rb-readline repository (https://github.com/ConnorAtherton/rb-readline). We are maintaining this fork and the related gem (rb-readline-r7) to resolve compatibility issues beween the Metasploit Framework and the current rb-readline gem.
